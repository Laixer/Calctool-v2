...
<html lang="en">
	...
	<head>
		...
		<title><strong>CalculatieTool.com</strong> - Account opgezegd</title>
	</head>
											...
											<tbody>
												...
												<tr>
													<td width="100%" style=" font-size: 14px; line-height: 24px; font-family:helvetica, Arial, sans-serif; text-align: left; color:#8E8E8E;">
														Je CalculatieTool account is zojuist <strong>gedeactiveerd</strong>. Mocht dit niet bedoeling zijn neem dan contact met ons op.
													</td>
												</tr>
												<tr><!-- spacer after the line -->
													<td width="100%" height="20"></td>
