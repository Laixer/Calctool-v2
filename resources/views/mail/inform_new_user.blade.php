											...
											<tbody>
												...
												<tr>
													<td width="100%" style=" font-size: 14px; line-height: 24px; font-family:helvetica, Arial, sans-serif; text-align: left; color:#8E8E8E;">
														Er heeft zich een nieuwe gebruiker aangemeld.
													</td>
												</tr>
												<tr>
													<td width="100%" style=" font-size: 14px; line-height: 24px; font-family:helvetica, Arial, sans-serif; text-align: left; color:#8E8E8E;">
														<strong>Gebruiker: {{ ucfirst($firstname) .' '. ucfirst($lastname) }}</strong>
													</td>
												</tr>
												<tr>
													<td width="100%" style=" font-size: 14px; line-height: 24px; font-family:helvetica, Arial, sans-serif; text-align: left; color:#8E8E8E;">
												...
												<tr>
													<td width="100%" style=" font-size: 14px; line-height: 24px; font-family:helvetica, Arial, sans-serif; text-align: left; color:#8E8E8E;">
														<strong>Bedrijf: {{ $company }}</strong>
													</td>
												</tr>
												<tr>
													<td width="100%" style=" font-size: 14px; line-height: 24px; font-family:helvetica, Arial, sans-serif; text-align: left; color:#8E8E8E;">
														<strong>Contact: {{ ucfirst($contact_first) .' '. ucfirst($contact_last) }}</strong>
													</td>
												</tr>
												<tr><!-- spacer after the line -->
													<td width="100%" height="20"></td>
