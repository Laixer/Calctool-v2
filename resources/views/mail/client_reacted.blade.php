                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="100%" style="text-align:center;">
                                                        <a href="{{ secure_url('/') }}" style="text-decoration:none; font-family: helvetica, Arial, sans-serif; font-size: 12px; letter-spacing: 0px; text-align: center; text-transform: uppercase; padding:10px; color:#ffffff; background-color:#79BB00; border-radius:6px;">
