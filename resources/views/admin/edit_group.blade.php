				...
				<div class="row company">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<input name="subscription_amount" id="subscription_amount" type="text" value="{{ Input::old('subscription_amount') ? Input::old('subscription_amount') : $group->subscription_amount }}" class="form-control"/>
						</div>
					</div>
