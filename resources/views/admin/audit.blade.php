					...
					<div class="white-row">
						...
						<table class="table table-striped">
							...
							<tbody>
								<?php
								if ($allevents) {
									$selection = \Calctool\Models\Audit::orderBy('created_at','desc')->get();
								} else {
									$selection = \Calctool\Models\Audit::orderBy('created_at','desc')->limit(50)->get();
								}
								?>
								...
								<tr>
									...
									<td class="col-md-2 hidden-sm hidden-xs"><a href="/admin/user-{{ $rec->user_id }}/edit">{{ \Calctool\Models\User::find($rec->user_id)->username }}</a></td>
