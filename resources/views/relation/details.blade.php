...
<form method="post" action="/relation/update">
{!! csrf_field() !!}
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input name="debtor" maxlength="10" id="debtor" type="text" value="{{ old('debtor') ? old('debtor') : $relation->debtor_code }}" class="form-control" required/>
...
<div class="row company">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input name="email_comp" maxlength="80" id="email_comp" type="email" value="{{ old('email_comp') ? old('email_comp') : $relation->email }}" class="form-control" required/>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input name="address_number" maxlength="5" id="address_number" type="text" value="{{ old('address_number') ? old('address_number') : $relation->address_number }}" class="form-control autoappend" required/>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input name="zipcode" id="zipcode" maxlength="6" type="text" value="{{ old('zipcode') ? old('zipcode') : $relation->address_postal }}" class="form-control autoappend" required/>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input name="street" maxlength="50" id="street" type="text" value="{{ old('street') ? old('street') : $relation->address_street }}" class="form-control" required/>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input name="city" maxlength="35" id="city" type="text" value="{{ old('city') ? old('city') : $relation->address_city }}" class="form-control" required/>
        </div>
    </div>
