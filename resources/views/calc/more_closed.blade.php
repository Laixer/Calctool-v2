...
use \BynqIO\CalculatieTool\Calculus\MoreRegister;
							...
							<div id="toggle-chapter-{{ $chapter->id }}" class="toggle toggle-chapter">
								...
								<div class="toggle-content">
									...
									<div class="toogle">
										...
										<?php
										foreach(Activity::where('chapter_id','=', $chapter->id)->where('part_type_id','=',PartType::where('type_name','=','calculation')->first()->id)->orderBy('priority')->get() as $activity) {
