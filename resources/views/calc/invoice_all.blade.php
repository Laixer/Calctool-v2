			...
			<table class="table table-striped">
				...
				<?php $invoice_version = InvoiceVersion::where('invoice_id', $invoice->id)->orderBy('created_at','desc')->first(); ?>
					<tr>
						...
						<td class="col-md-2">{{ Auth::user()->pref_use_ct_numbering ? $invoice->invoice_code : $invoice->book_code }}</td>
				...
				<?php $invoice_version = InvoiceVersion::where('invoice_id', $invoice_end->id)->orderBy('created_at','desc')->first(); ?>
					<tr>
						...
						<td class="col-md-2">{{ Auth::user()->pref_use_ct_numbering ? $invoice_end->invoice_code : $invoice_end->book_code }}</td>
