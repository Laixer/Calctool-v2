			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th class="col-md-2">Bedrag (&euro;) (Excl. BTW) <a data-toggle="tooltip" data-placement="bottom" data-original-title="Geef hier een termijnbedrag of eindbedrag op." href="javascript:void(0);"><i class="fa fa-info-circle"></i></a></th>
