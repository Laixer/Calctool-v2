    ...
    <table class="table table-striped hide-btw2">
      <thead>
        ...
        <tr>
          ...
          <td style="width: 385px" class="qty"><strong>{{ $count+1 }}e van in totaal {{Invoice::where('offer_id','=', $invoice->offer_id)->whereRaw('(amount > 0 OR amount IS NULL)')->count()}} betalingstermijnen</strong> @if(!$project->tax_reverse)<i>(Excl. BTW)</i> @endif</td>
