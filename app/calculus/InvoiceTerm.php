...
class InvoiceTerm {
	...
	public static function totalProjectBalance($project, $offerid) {
		$total = 0;

		$total += (InvoiceTerm::totalTax1($project) - Invoice::where('offer_id','=',$offerid)->sum('rest_21'));
		$total += (InvoiceTerm::totalTax2($project) - Invoice::where('offer_id','=',$offerid)->sum('rest_6'));
		$total += (InvoiceTerm::totalTax3($project) - Invoice::where('offer_id','=',$offerid)->sum('rest_0'));

		return $total;
	}

	public static function partTax1($project, $offerid) {
		return (InvoiceTerm::totalTax1($project) - Invoice::where('offer_id','=',$offerid)->sum('rest_21')) / InvoiceTerm::totalProjectBalance($project, $offerid);
	}

	public static function partTax2($project, $offerid) {
		return (InvoiceTerm::totalTax2($project) - Invoice::where('offer_id','=',$offerid)->sum('rest_6')) / InvoiceTerm::totalProjectBalance($project, $offerid);
	}

	public static function partTax3($project, $offerid) {
		return (InvoiceTerm::totalTax3($project) - Invoice::where('offer_id','=',$offerid)->sum('rest_0')) / InvoiceTerm::totalProjectBalance($project, $offerid);
	}
