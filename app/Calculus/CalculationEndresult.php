...
class CalculationEndresult {
	...
	public static function conCalcLaborActivityTax1($project) {
		$total = 0;
		$part_id = \BynqIO\Dynq\Models\Part::where('part_name','=','contracting')->first()->id;
		$tax_id = \BynqIO\Dynq\Models\Tax::where('tax_rate','=','21')->first()->id;

		foreach (\BynqIO\Dynq\Models\Chapter::where('project_id','=', $project->id)->get() as $chapter)
		{
	...
	public static function conCalcLaborActivityTax2($project) {
		$total = 0;
		$part_id = \BynqIO\Dynq\Models\Part::where('part_name','=','contracting')->first()->id;
		$tax_id = \BynqIO\Dynq\Models\Tax::where('tax_rate','=','6')->first()->id;
	...
	public static function conCalcLaborActivityTax3($project) {
		$total = 0;
		$part_id = \BynqIO\Dynq\Models\Part::where('part_name','=','contracting')->first()->id;
		$tax_id = \BynqIO\Dynq\Models\Tax::where('tax_rate','=','0')->first()->id;
	...
	public static function conCalcLaborActivityTax1Amount($project) {
		...
		foreach (\BynqIO\Dynq\Models\Chapter::where('project_id','=', $project->id)->get() as $chapter)
		{
			foreach (\BynqIO\Dynq\Models\Activity::where('chapter_id','=', $chapter->id)->where('part_id','=',$part_id)->where('tax_labor_id','=',$tax_id)->get() as $activity)
			{
				if (PartType::find($activity->part_type_id)->type_name=='estimate') {
	...
	public static function subconCalcLaborActivityTax1($project) {
		$total = 0;
		$part_id = \BynqIO\Dynq\Models\Part::where('part_name','=','subcontracting')->first()->id;
		$tax_id = \BynqIO\Dynq\Models\Tax::where('tax_rate','=','21')->first()->id;
