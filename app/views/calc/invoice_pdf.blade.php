  ...
  <body>
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div id="invoice">
          <h3 class="name">Factuurnummer</h3>
          <div class="date">Projectnaam</div>
          <div class="date">Referentie</div>
          <div class="date">Boekhoudkundignummer</div>
    ...
    @if ($totaal)
     <h1 class="name">Totaalkosten calculeren per werkzaamheid</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
     ...
     <h1 class="name">Totalen Calculeren per project</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
            <th class="no">&nbsp;</th>
    ...
    @if ($totaal)
     <h1 class="name">Totaalkosten Stelposten per werkzaamheid</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
            <th class="no">Hoofdstuk</th>
     ...
     <h1 class="name">Totalen Stelposten per project</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
            <th class="no">&nbsp;</th>
     ...
     @if ($totaal)
     <h1 class="name">Totaalkosten Minderwerk per werkzaamheid</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
            <th class="no">Hoofdstuk</th>
     ...
     <h1 class="name">Totalen Minderwerk per project</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
            <th class="no">&nbsp;</th>
    ...
    @if ($totaal)
     <h1 class="name">Totaalkosten Meerwerk per werkzaamheid</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
            <th class="no">Hoofdstuk</th>
     ...
     <h1 class="name">Totalen Meerwerk per project</h1>
     <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr style="page-break-after: always;">
            <th class="no">&nbsp;</th>
