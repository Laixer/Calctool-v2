	...
	<section class="container">
		...
		<article>
			<h2><strong>Over</strong> ons</h2>
				...
				<h4>Wie wij zijn</h4>
				<p>Het bedrijf CalcTool is een kleine onderneming met één been in de ICT dienstverlening en het andere in de bouwwereld. CalcTool haalt de computerwereld naar de ambachten met als resultaat een makkelijke en snelle manier van calculeren, offreren en factureren van projecten.
				Ervaren zzp-ers uit de bouw en doorgewinterde programmeurs werken samen en vormen de hoeksteen van ons bedrijf. CalcTool brengt op geheel eigenwijze de welbekende sigarendoos-calculatie volledig digitaal en sterk uitgebreid met zeer groot gebruikersgemak naar de zzp-er. De ontwerp gedachte is daarbij altijd geweest een overzichtelijke manier van calculeren te maken waarin tevens gemakkelijk het beheren van stelposten, meerwerk & minderwerk is uit te voeren door zowel ervaren als onervaren computergebruikers.
				...
				<p>De ontwikkeling van de CalculatieTool staat binnen ons bedrijf nooit stil. De ICT wereld veranderd voortdurend. CalcTool blijft zich daarom inzetten om altijd het beste en meest volledige product te leveren voor de laagste prijs in de markt.
				Onze visie: Wij van CalcTool willen graag de Zzp-er van deze tijd de waarde van een programma als dit laten ervaren en dat tegen een betaalbare prijs.
				Tegenwoordig is het een heel karwei om werk binnen te halen en het kost ontzettend veel tijd en geld om steeds weer opnieuw offertes op te stellen. Dit gaat ten koste van de kwaliteit van de offertes.
				In deze tijd is het belangrijk om het verschil niet alleen in kwaliteit te maken maar ook in de prijs van een werk. Met de CalculatieTool kunt u ouderwets calculeren op de manier van het “bierviltje” alleen 50-75% sneller en effectiever. U krijgt dus veel betere en nettere offertes in minimaal de helft van de tijd. Zo kunt u kunt sneller gaan doen waar u goed in bent en dat is op de werkvloer de werkzaamheden uitvoeren.
				Aan de hand van de onderstaande checklist controleert u of uw website voldoet aan de voorwaarden. Meer informatie vindt u op de website van Autoriteit Consument & Markt (ACM).</p>

				<h4>Ons Doel</h4>
				<p>De CalculatieTool is gemaakt voor Zzp-ers die zich professioneler willen gaan bewegen op de markt en de toegevoegde waarde herkennen in een calculatieprogramma zoals de CalculatieTool.
