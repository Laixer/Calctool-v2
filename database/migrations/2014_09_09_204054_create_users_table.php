...
class CreateUsersTable extends Migration {
	...
	public function up()
	{
		...
		Schema::create('user_group', function(Blueprint $table)
		{
			...
			$table->boolean('experimental')->default('N');
		...
		Schema::create('user_account', function(Blueprint $table)
		{
			...
			$table->text('pref_email_invoice')->nullable()->default('Bij deze doe ik u toekomen mijn factuur betreffende het uitgevoerde werk. De factuur heb ik in de bijlage toegevoegd. Mocht u vragen hebben, stel ze gerust, dan beantwoord ik deze graag.');
			$table->text('pref_invoice_description')->nullable()->default('Bij deze doe ik u toekomen mijn factuur betreffende het uitgevoerde werk behorende bij offerte. Hierin zit tevens het eventuele meer- en minderwerk en de stelpost verwerkt zoals besproken.');
			$table->text('pref_invoice_closure')->nullable()->default('Met dank voor uw opdracht en vertrouwen in ons bedrijf.');
			$table->text('pref_email_invoice_first_reminder')->nullable()->default('Volgens onze administratie hebben wij nog geen betaling van bijgevoegde factuur mogen ontvangen. Wij verzoeken u het verschuldigde bedrag binnen 14 dagen over te maken op het in de factuur genoemde rekeningnummer onder vermelding van uw debiteurennummer en het factuurnummer. Heeft u vragen over de factuur of bent u van mening dat deze ten onrechte is verstuurd, neem dan contact op met ondergetekende. Indien het bedrag inmiddels is overgemaakt kunt u deze brief uiteraard als niet verzonden beschouwen. ');
			$table->text('pref_email_invoice_last_reminder')->nullable()->default('Uit onze administratie is gebleken dat bovenvermelde factuur na onze eerste herinnering nog steeds niet door u is voldaan. De betalingstermijn is hiermee onaanvaardbaar overschreden. Wij verzoeken u het verschuldigde bedrag binnen 7 dagen over te maken op het in de factuur genoemde rekeningnummer onder vermelding van uw debiteurennummer en het factuurnummer. Heeft u vragen over de factuur of bent u van mening dat deze ten onrechte is verstuurd, neem dan contact op met ondergetekende. Indien het bedrag inmiddels is overgemaakt kunt u deze brief uiteraard als niet verzonden beschouwen. ');
			$table->text('pref_email_invoice_demand')->nullable()->default('Ondanks twee eerdere herinneringen hebben wij nog geen betaling van bijgevoegde factuur mogen ontvangen. Wij verzoeken u dringend het verschuldigde bedrag binnen 5 dagen over te maken op het in de factuur genoemde rekeningnummer onder vermelding van uw debiteurennummer en het factuurnummer. Als deze laatste aanmaning u niet aanzet tot betaling binnen de genoemde termijn, zijn wij genoodzaakt de vordering definitief uit handen te geven. Alle hieruit voortkomende kosten zullen voor uw rekening komen.');
